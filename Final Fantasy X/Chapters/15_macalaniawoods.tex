...
\begin{enumerate}[resume]
    ...
    \item You have \textbf{one} spare \textit{Lightning Marble}, could use it to kill the Bees for extra Speed Spheres, if needed
    \item Follow path, don't get confused coming out of battle
    \item Catch butterfly near the exit to avoid encounters
    \item Rikku could get last sliver of \od from the next boss
    \item \formation{\tidus}{\kimahri}{\auron} (should be it)
    \item \save, talk to O'aka, \nth{1} option, exit the shop, \nth{1} option, talk to him again, \nth{1} option
    \item \formation{\tidus}{\yuna}{\rikku} for alternative strats
\end{enumerate}
\begin{shop}{11550}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \blitzballdetermination[true]{%
                \item Move $\uparrow\uparrow\leftarrow$ t o Steal node
            }{%
