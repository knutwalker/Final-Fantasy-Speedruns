...
\begin{trial}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item At the \nth{3} junction, go back (hold \Confirm)
            \item Go left at the \nth{2} junction
            \item Place sphere into wall, push pedestal back
            \item At the \nth{3} junction, go back (hold \Confirm)
            \item Go left at the \nth{1} junction (hold \Confirm\ after the \nth{2} junction)
        \end{itemize}
        \item \textit{Lower section (\nth{1} visit):}
        \begin{itemize}
            \item The platform will automatically stop at the \nth{1} junction
            \item After the platform stops, press \Confirm\ the \nth{2} time the arrow is pointing left
            \item Go right at the \nth{3} junction (hold \Confirm\ after the \nth{2} junction)
            \item Take Glyph sphere from wall, push pedestal back
            \item At the \nth{4} junction go right (hold \Confirm)
        ...
        \begin{itemize}
            ...
            \item At the \nth{3} junction go right (hold \Confirm\ after the \nth{2} junction)
        ...
        \begin{itemize}
            \item watch the next arrow, need to go right
            \item Go straight, likely on the second time
            \item At the \nth{1} junction go right (hold \Confirm)
            \item Push pedestal
