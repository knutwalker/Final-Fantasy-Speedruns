...
\begin{enumerate}[resume]
    ...
    \item Need 45 AP on \tidus, which is 5 kills (Overkills count as 2)
    \item At most 17 kills for speed spheres (Overkills count as 2)
    \item This is your main source of Speed Spheres but you can obtain the rest later
...
\begin{trial}
    \begin{itemize}
        ...
        \item Take the glyph sphere from the pedestal (take from behind)
