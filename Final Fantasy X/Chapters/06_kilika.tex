...
\begin{spheregrid}
    \begin{itemize}
        \tidusf
        \item \textit{If \tidus\ had 3 levels on the last grid}
        \begin{itemize}
            \item Move $\leftarrow\leftarrow$ or $\nwarrow$
            \item Flee, Agi+1
        \end{itemize}
        \item \textit{If \tidus\ only had 2 levels on the last grid}
        \begin{itemize}
            \item Move $\uparrow$
            \item Flee, Agi+1, Str +1
        \end{itemize}
...
\begin{enumerate}[resume]
    ...
    \item \formation{\tidus}{\wakka}{\lulu} (\swap{\lulu}{\yuna})
