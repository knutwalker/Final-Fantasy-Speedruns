...
\begin{shop}{3050}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textit{Equip is for Garuda, can also keep Brotherhood for bit more damage now and switch Weapons in Garuda fight}
        \end{itemize}
...
\begin{enumerate}[resume]
    ...
    \item Go up the stairs to the locker room
    \item Go back into locker room, right side down to \wakka
\end{enumerate}
\begin{blitzball}
    \begin{itemize}
        ...
        \end{itemize}
        \item Don't try to score in the First Half (Goers aggro if behind)
...
\begin{battle}[1800]{Garuda}
    \textit{Dark Attack strats}
    \begin{itemize}
        \tidusf Haste \auron
        \wakkaf Dark Attack (less healing duty, can attack later as well)
        \auronf Attack x3
        \wakkaf Defend, Potion if \tidus\ has less than 312 HP, Attack if Garuda is blind
        \tidusf Switch weapong to Stunning Steel if not already, Attack x1, then Defend
