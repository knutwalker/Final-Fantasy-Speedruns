...
\begin{blitzball}
    \begin{itemize}
        ...
        \end{itemize}
        \item Don't try to score in the First Half (It's slower to score in \nth{1} half compared to \nth{2} half)
...
\begin{battle}[1800]{Garuda}
    \begin{itemize}
        \tidusf Haste \auron
        \auronf Attack x3
        \wakkaf Potion \tidus\ if he has less than 312 HP, Defend
        \tidusf Attack x1, then Defend
        \wakkaf Potion \auron\ if he has less than 202 HP, Defend
        \auronf Attack x3
