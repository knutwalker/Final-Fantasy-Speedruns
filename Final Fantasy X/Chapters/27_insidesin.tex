...
\begin{enumerate}[resume]
    ...
    \item Mash Triangle if you want to the sphere grid before the autosave point
\end{enumerate}
\begin{spheregrid}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Move $\nwarrow$ opn top of Spare Change
            \item Spare Change
            \item Attribute Sphere \kimahri's +4 Agi
            \item If you don't have enough S.Lvl for Spare Change, reach it from \kimahri or use a Return Sphere
        \end{itemize}
...
\begin{battle}{Possessed Aeons}
    \begin{itemize}
        ...
        \end{itemize}
        \item If you don't have Spare Change:
        \begin{itemize}
            \yunaf Attack
            \tidusf Attack
            \yunaf Summon \bahamut\ and Attack
            \yunaf Summon \shiva\ and \od
        \end{itemize}
    \end{itemize}
\end{battle}
\colend
