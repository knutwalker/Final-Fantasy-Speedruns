...
\begin{enumerate}[resume]
    ...
    \item If you don't have enough S.Lvl for Spare Change (only happens if you made as mistake somewhere before):
    \begin{itemize}
        \item Teach Spare Change to \kimahri\ or \rikku
        \item If you have a Special Sphere (rare drop from Seymour) teach it to \yuna
        \item Or use \yuna\ to either Summon or Attack (Attack will miss a lot, expect to waste minutes)
    \end{itemize}
\end{enumerate}
\begin{spheregrid}
    \begin{itemize}
