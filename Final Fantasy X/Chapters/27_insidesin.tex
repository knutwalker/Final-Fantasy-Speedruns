...
\begin{enumerate}[resume]
    ...
    \item Mash Triangle if you want to do the sphere grid before the autosave point
\end{enumerate}
\begin{spheregrid}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item If you don't have enough S.Lvl for Spare Change, reach it from \kimahri\ and Special Sphere or use a Return Sphere
        \end{itemize}
