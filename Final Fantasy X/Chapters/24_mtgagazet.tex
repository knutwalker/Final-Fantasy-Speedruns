...
\begin{enumerate}[resume]
    ...
    \begin{itemize}
        \yunaf Staff $\rightarrow$ First Strike
    \end{itemize}
    \item \formation{\tidus}{Not \yuna}{Not \yuna}
\end{enumerate}
\begin{enumerate}[resume]
    ...
    \item \textit{If you had 2 or 4 \textbf{Return Spheres}} \formation{\tidus}{\yuna}{\auron}, otherwise \formation{\tidus}{Not \yuna}{Not \yuna}
\end{enumerate}
...
\begin{enumerate}[resume]
    ...
    \item \formation{\tidus}{\yuna}{Any}. Go onto the next screen.
\end{enumerate}
