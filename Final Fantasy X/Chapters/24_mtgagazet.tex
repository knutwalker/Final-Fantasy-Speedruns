...
\begin{spheregrid}[\textbf{2 Return Spheres}]
    \begin{itemize}
        ...
        \tidusf \textit{Saving levels:} Return Sphere $\downarrow\searrow\searrow$ (or Hold $\searrow$) to Str+4 near Armor Break
...
\begin{enumerate}[resume]
    ...
    \item Need grenaed: \rikku\: Steal from Mech Leader and Escape with the others
...
\begin{battle}[70000]{Seymour Flux}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \tidusf Haste \yuna
            \switch{\auron}{\rikku}
            \rikkuf \od\ HP Sphere + Grenade or Silence Grenade (preferably Grenade)
            \summon{\bahamut}
...
\begin{enumerate}[resume]
    ...
    \item \tidus\ can attack Solo-Splashers for Power Spheres: You need as many Power Sphere as you got \textbf{Return Spheres} (not additional).
